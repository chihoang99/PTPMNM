...
class business_accounting_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function business_accounting_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function business_accounting_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function business_accounting_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function business_accounting_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->business_accounting_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function business_accounting_load( $class ) {
