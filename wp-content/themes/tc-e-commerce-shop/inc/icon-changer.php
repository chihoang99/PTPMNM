...
class TC_E_Commerce_Shop_Icon_Changer extends WP_Customize_Control{
      public $type = 'icon';
            ...
            <label>
                  ...
                  <ul class="icon-list">
                        <div class="social-icon-search">
                              <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'tc-e-commerce-shop'); ?>">
                        </div>
                        <?php
                        $tc_e_commerce_shop_font_awesome_icon_array = tc_e_commerce_shop_font_awesome_icon_array();
                        foreach ($tc_e_commerce_shop_font_awesome_icon_array as $tc_e_commerce_shop_font_awesome_icon) {
                              $icon_class = $this->value() == $tc_e_commerce_shop_font_awesome_icon ? 'icon-active' : '';
                              echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($tc_e_commerce_shop_font_awesome_icon).'"></i>
                                    <span class="icons-class">'.esc_attr($tc_e_commerce_shop_font_awesome_icon).'</span>
                              </li>';
                        }
                        ?>
                  </ul>
...
function tc_e_commerce_shop_customizer_script() {
    wp_enqueue_style( 'font-awesome-1', get_template_directory_uri().'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'tc_e_commerce_shop_customizer_script' );

if(!function_exists('tc_e_commerce_shop_font_awesome_icon_array')){
    function tc_e_commerce_shop_font_awesome_icon_array(){
        return array("None", 
            "fab fa-500px",
