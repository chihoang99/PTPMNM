...
<footer role="contentinfo">
    ...
    <?php if( get_theme_mod( 'tc_e_commerce_shop_show_back_to_top',true) != '') { ?>
        ...
        if($tc_e_commerce_shop_scroll_lay == 'Left'){ ?>
            <a href="#" class="scrollup left"><span><?php echo esc_html( get_theme_mod('tc_e_commerce_shop_back_to_top_text',__('Back to Top', 'tc-e-commerce-shop' )) ); ?><?php if(get_theme_mod('tc_e_commerce_shop_back_to_top_icon') != 'None') {?><i class="<?php echo esc_html(get_theme_mod('tc_e_commerce_shop_back_to_top_icon','fas fa-arrow-up')); ?>"></i><?php }?></span><span class="screen-reader-text"><?php echo esc_html( get_theme_mod('tc_e_commerce_shop_back_to_top_text',__('Back to Top', 'tc-e-commerce-shop' )) ); ?></span></a>
