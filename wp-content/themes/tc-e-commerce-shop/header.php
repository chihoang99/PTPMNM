        ...
        <div class="container">
          <div class="baricon">
            <?php if( get_theme_mod( 'tc_e_commerce_shop_mail','' ) != '') { ?>
              <a href="mailto:<?php echo esc_attr( get_theme_mod('tc_e_commerce_shop_mail','')); ?>"><span class="email"><?php if(get_theme_mod('tc_e_commerce_shop_mail_icon') != 'None'){?><i class="<?php echo esc_html(get_theme_mod('tc_e_commerce_shop_mail_icon','fa fa-envelope')); ?> " aria-hidden="true"></i><?php }?><?php echo esc_html( get_theme_mod('tc_e_commerce_shop_mail','') ); ?></span><span class="screen-reader-text"><?php esc_html_e( 'Email','tc-e-commerce-shop' );?></span></a>
            <?php } ?>
            <?php if( get_theme_mod( 'tc_e_commerce_shop_call','' ) != '') { ?>
              <a href="tel:<?php echo esc_attr( get_theme_mod('tc_e_commerce_shop_call','')); ?>"><span class="call"><?php if(get_theme_mod('tc_e_commerce_shop_phone_icon') != 'None'){?><i class="<?php echo esc_html(get_theme_mod('tc_e_commerce_shop_phone_icon','fa fa-phone')); ?>" aria-hidden="true"></i><?php }?><?php echo esc_html( get_theme_mod('tc_e_commerce_shop_call','')); ?></span><span class="screen-reader-text"><?php esc_html_e( 'Phone Number','tc-e-commerce-shop' );?></span></a>
            <?php } ?>
            <?php if( get_theme_mod( 'tc_e_commerce_shop_facebook_url') != '' && get_theme_mod('tc_e_commerce_shop_phone_icon') != 'None') { ?>
              <a href="<?php echo esc_url( get_theme_mod( 'tc_e_commerce_shop_facebook_url','' ) ); ?>"><i class="<?php echo esc_html(get_theme_mod('tc_e_commerce_shop_phone_icon','fab fa-facebook-f')); ?>" aria-hidden="true"></i><span class="screen-reader-text"><?php esc_html_e( 'Facebook','tc-e-commerce-shop' );?></span></a>
            <?php } ?>
            <?php if( get_theme_mod( 'tc_e_commerce_shop_twitter_url') != '' && get_theme_mod('tc_e_commerce_shop_twitter_icon') != 'None') { ?>
              <a href="<?php echo esc_url( get_theme_mod( 'tc_e_commerce_shop_twitter_url','' ) ); ?>"><i class="<?php echo esc_html(get_theme_mod('tc_e_commerce_shop_twitter_icon','fab fa-twitter')); ?>" aria-hidden="true"></i><span class="screen-reader-text"><?php esc_html_e( 'Twitter','tc-e-commerce-shop' );?></span></a>
            <?php } ?>
            <?php if( get_theme_mod( 'tc_e_commerce_shop_instagram_url') != '' && get_theme_mod('tc_e_commerce_shop_instagram_icon') != 'None') { ?>
              <a href="<?php echo esc_url( get_theme_mod( 'tc_e_commerce_shop_instagram_url','' ) ); ?>"><i class="<?php echo esc_html(get_theme_mod('tc_e_commerce_shop_instagram_icon','fab fa-instagram')); ?>"></i><span class="screen-reader-text"><?php esc_html_e( 'Instagram','tc-e-commerce-shop' );?></span></a>
            <?php } ?>
            <?php if( get_theme_mod( 'tc_e_commerce_shop_youtube_url') != '' && get_theme_mod('tc_e_commerce_shop_youtube_icon') != 'None') { ?>
              <a href="<?php echo esc_url( get_theme_mod( 'tc_e_commerce_shop_youtube_url','' ) ); ?>"><i class="<?php echo esc_html(get_theme_mod('tc_e_commerce_shop_youtube_icon','fab fa-youtube')); ?>" aria-hidden="true"></i><span class="screen-reader-text"><?php esc_html_e( 'Youtube','tc-e-commerce-shop' );?></span></a>
            <?php } ?>
          </div>
        </div>
      </div>
